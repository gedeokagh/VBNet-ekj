...
Public Class RptTiketDaili
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ekajaya.RptTiketDaili.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTiketDaili
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTiketDaili = New RptTiketDaili()
        rpt.Site = Me.Site
        Return rpt
    End Function
