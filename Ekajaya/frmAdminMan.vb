...
Public Class frmAdminMan
    ...
    Private Sub cmdFilter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFilter.Click
        ...
        Dim sql As String = ""
        Dim ands As Boolean = False
        If cboPort.SelectedItem("PortID") >= 1 Then
            Dim andX As Boolean = False
            If cboAgent.Text = "" Then
            Else
                str = " (tiketdtl.AgentID='" & cboAgent.SelectedItem("AgentID").ToString() & "')"
    ...
    Private Sub LsData_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
        If LsData.RowCount = 0 Then
            MsgBox("No Data To Update", vbInformation, "No Data")
            Exit Sub
        End If
    ...
    Private Sub LsData_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
