...
Public Class frmAdminRes
    ...
    Private Sub cmdDepart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDepart.Click
        ...
        '    LsData.CurrentRow.Cells(21).Value = 1
    ...
    Private Sub cmdreactive_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdreactive.Click
        Try
            ...
            FillLog(usr, "Active Tiket", " Reset Tiket , TiketNo=" & LsData.CurrentRow.Cells(1).Value & ", Etiket =" & LsData.CurrentRow.Cells(0).Value, "", "status=1,departgo=0,departback=0 ")
        Catch ex As MySqlException
            MsgBox(ex.Message)
        Finally
            ' Close connection
