...
Public Class frmCancelPayment
    ...
    Sub fillagent()
        ...
        Dim dt As DataTable
        da = New MySqlDataAdapter("select tiketdtl.AgentID as AgentID,agent.AgentName as AgentName from tiketdtl inner join agent on tiketdtl.agentID=agent.AgentID where tiketdtl.inv=1  AND tiketdtl.pay=1 and godate>='2018-08-01' group by tiketdtl.AgentID", conn)
        dt = New DataTable
        da.Fill(dt)
    ...
    Sub fillInv()
        ...
        Dim da As MySqlDataAdapter
        Dim dt As DataTable
        da = New MySqlDataAdapter("Select NoInv from tiketdtl where AgentID='" & cboAgent.SelectedItem("AgentID").ToString() & "' and tiketdtl.inv=1 AND tiketdtl.pay=1 and godate>='2018-08-01'  group by NoInv", conn)
        dt = New DataTable
        da.Fill(dt)
    ...
    Private Sub frmCancelPayment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        fillagent()
