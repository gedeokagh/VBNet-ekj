...
Public Class rptShuttleList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ekajaya.rptShuttleList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptShuttleList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptShuttleList = New rptShuttleList()
        rpt.Site = Me.Site
        Return rpt
    End Function
